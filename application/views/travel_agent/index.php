										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Travel Agents</span>
												
												</h3>
												<div class="card-toolbar">
													<a href="add" class="btn btn-success font-weight-bolder font-size-sm">
													<i class="fa fa-plus"></i>Add Travel Agent</a>
												</div>
											</div>
											<!--begin::Body-->
											   ...
											   ?>
                                                 ...
                                                 <td><?php echo $rev['name'] ?></td>
                                                    ...
                                                    <td><?php echo $rev['address'] ?></td>
                                                      <td>
                                                          <a href="<?php echo base_url(); ?>index.php/travel_agent/edit/<?php echo $rev['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
