...
<!--begin::Entry-->
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Payment Margins</span>
												
												</h3>
												<div class="card-toolbar">
													<a href="add" class="btn btn-success font-weight-bolder font-size-sm">
													<i class="fa fa-plus"></i>Add Payment Margins</a>
												</div>
											</div>
											<!--end::Header-->
											<!--begin::Body-->
                      ...
                      if($this->session->userdata('user_type')==1)
                      {
                        ?>
                                                <td>
                                                     <a href="<?php echo base_url(); ?>index.php/margin/edit/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                                 ...
                                                 <a href="<?php echo base_url(); ?>index.php/margin/remove/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
