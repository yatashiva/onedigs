    ...
    <div class="row">
        <div class="footer_widget clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-6">
                <a target="_blank" href="https://www.facebook.com/nohorooms">
                    <i style="font-size:35px;padding-left: 10px;" class="fab fa-facebook-f"></i>
                </a>
                <a target="_blank" href="https://twitter.com/nohorooms" class="fl padR10" title="Twitter" data-reactid="298">
    ...
    <div class="footer_widget clearfix">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <ul>
                ...
                <li>
                    <a href="<?php echo base_url();?>index.php/careers">Careers</a>
                </li>
        ...
        <div class="col-lg-6 col-md-6 sol-sm-6">
            <ul>
                ...
                <li>
                   <a href="<?php echo base_url();?>index.php/hotel/feedback_contact">Feedback</a>
                </li>
                <li>
                   <a href="<?php echo base_url();?>index.php/hotel/feedback_contact">Contact us</a>
                </li>
                <!-- Removing faq upon clients request -->
                <!-- <li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="loginform">
                        ...
                        <br><br>
                        <input type="text" class="form-control popstyle" name="email" id="email" placeholder="Enter here" value="<?php if($this->input->cookie('user_name')) { echo $this->input->cookie('user_name',true); } ?>"  />
                        <br>
                        <?php
                      
                        ?>
                        <input type="checkbox" name="remember" <?php if($this->input->cookie('user_name')) { echo "checked" ; } ?> > Remember Me
                        <br>
                        <br>
