...
<div class="contactus">
	<div class="container">
		<div class="row">
          ...
          <h2 class=" page-header text-center">Feedback-Contact Form</h2>
					<i class="icon_star_alt"></i>
				</h4>
				<p></p>
			</div>
			<div class="col-sm-offset-2 col-md-8 col-sm-8  col-xs-12">
				<form action="<?php echo base_url();?>index.php/feedback_contact/" method="post" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-md-12 col-sm-12 col-xs-12">
                            <input type="number" id="cname" name="contact_number" placeholder="Your Contact Number"class="form-control"/>
						</div>
					</div>
          
          <div class="form-group">
						<div class="col-md-12 col-sm-12 col-xs-12">
                            <input type="email" id="emailId" name="emailId" placeholder="Your Email Id"class="form-control"/>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-12 col-md-12 col-xs-12">
							...
							<textarea id="mSummary" name="message_summary" placeholder="Brief your message.." class="form-control" ></textarea>
						</div>
					</div>
...
<!-- added the below code as client wants this address included in the page urgently, should modify the design of this page -->
<br><br><br>
<h2 class=" text-center" style="text-decoration: underline;margin-top: 0px;" > Get in touch with Nohorooms</h2>
  
<p class=" text-center" style="margin-top: 0px;">Flot no   301, srilakshmi residency,<br>
ushodaya junction,MVP colany,<br>
visakhapatnam  530017-AP, India.<br></p>
...
<div class="container">
   <form action="<?php echo base_url();?>index.php/careers/" method="post">
     ...
     <input type="number" id="Cname" name="contact_number" placeholder="Your Contact Number">
