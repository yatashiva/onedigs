							    ...
							    <div class="row">
							        ...
							        <div class="col-xl-12">
										...
										<div class="card-title">
											...
											<h3 class="card-label">Hotels Inventory</h3>
										</div>
											...
											<div class="card-body py-0" style="margin-top:10px">
                                               ...
                                               <?php foreach($hotels as $rev){ ?>
                                                <tr> 
                                                    ...
                                                    <td>
                                                        <a  href="<?php echo base_url() ?>index.php/inventory/inventorydisplay/<?php echo $rev['id'] ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
