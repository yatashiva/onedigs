...
<div class="page-bar">
  ...
  <div class="card-box col-md-8  modal-body">
    <div class='card-head'>
	 ...
	 <div class='card-body'>
        <form action="<?php echo base_url(); ?>index.php/admin/editprofile" method="POST" enctype="multipart/form-data" style='width:100%'>
          ...
          <div class='col-md-6'> 
                    <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                        ...
                        <input type="test" class = "mdl-textfield__input" id="name" name="username"  value="<?php echo $details['username'] ?>">
                    </div>
           </div>
           <div class='col-md-6'> 
                    <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                        <label class = "mdl-textfield__label" for="simpleFormEmail">Email address</label>
                        <input type="email" class = "mdl-textfield__input" id="email" name="email" value="<?php echo $details['email'] ?>">
                    </div>
           </div> 
           <div class='col-md-6'> 
                    <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                        <label class = "mdl-textfield__label" for="simpleFormEmail">Number</label>
                        <input type="number" class = "mdl-textfield__input" id="phone_no" name="phone_no" value="<?php echo $details['phone_no'] ?>">
                    </div>
           </div> 

      <!-- added the below fields to show the travel agent pan and gst numbers, based on clients inputs       -->
    <?php if( $details['user_type'] == 4){?>

           <div class='col-md-6'> 
                    <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                        <label class = "mdl-textfield__label" for="simpleFormEmail">GST Number</label>
                        <input type="text" class = "mdl-textfield__input" id="gst_no" name="gst_no" value="<?php echo $agent_detail['gst_no']; ?>">
                    </div>
           </div> 
           
           <div class='col-md-6'> 
                    <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                        <label class = "mdl-textfield__label" for="simpleFormEmail">PAN Number</label>
                        <input type="text" class = "mdl-textfield__input" id="pan_no" name="pan_no" value="<?php echo $agent_detail['pan_no']; ?>">
                    </div>
           </div> 
          <?php }?>        
