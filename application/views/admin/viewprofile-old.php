...
<div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-left">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">View Profile</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
...
<div>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <label class = "mdl-textfield__label" for="exampleInputEmail1">Number</label>
                    </div>
                    <div class="col-md-6">
                        <p><?php echo $details['phone_no']; ?></p>
                    </div>
                </div>
                </div>
                ...
                <!-- added the below fields to travel agent login, based on clinets inputs -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <p><?php echo $agent_detail['gst_no']; ?>
                        <a title="edit" href="<?php echo base_url(); ?>index.php/Admin/editprofile/<?php echo $details['id']; ?>"><span class="fa fa-pencil"></span></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <p><?php echo $agent_detail['pan_no']; ?>
                        <a title="edit" href="<?php echo base_url(); ?>index.php/Admin/editprofile/<?php echo $details['id']; ?>"><span class="fa fa-pencil"></span></a>
                        </p>
                    </div>
                </div>
        ...
        <div align='center'> 
              <a href="<?php echo base_url(); ?>/index.php/admin/editprofile">EDIT</a>
			  </div>
            </form>
			</div>
      </div>
