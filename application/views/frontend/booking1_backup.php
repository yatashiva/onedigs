                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            ...
                            <div class="item">
                                ...
                                <?php  } ?>
                                <img src="<?php echo base_url(); ?>gallery/<?php echo $hotels['id'].'/commonfiles'.'/'.$images[$i]?>" style="width:555px; height:319px;"
                                    alt="Los Angeles">
                            </div>
                            <?php 
                            }
...
foreach ($categories as $category)
{
    ...
    ?>
                                                <li role="presentation" class="active">
                                                    <a href="#tab1" role="tab" data-toggle="tab" style='height: 40px;padding-top: 5px;'>
                                                        <h5 class="text-center" style='font-size:15px;'>
                                                            <?php echo $category['name']; ?>Room</h5>
                                                    </a>
                                                </li>
                                                <?php
                                                }
                                                ...
                                                ?>
                                                    ...
                                                    <!-- <li role="presentation">
                                                <a href="#tab<?php echo $x; ?>" role="tab" data-toggle="tab" style='height: 40px;padding-top: 5px;'>
                                                        <h5 class="text-center" style='font-size:15px;'><?php echo $category['name']; ?>Room</h5>
                                                </a>
                                                  </li>
												  <li role="presentation">
                                                <a href="#tab<?php echo $x; ?>" role="tab" data-toggle="tab" style='height: 40px;padding-top: 5px;'>
...
foreach ($categories as $category)
{
    ...
    ?>
                                        <div role="tabpanel" class="tab-pane active" id="tab1">
                                            ...
                                            <div class="row" style="padding-top:3%">
                                                <div class="col-md-8">
                                                    <span style="font-size: 20px !important;color:black">
                                                        <?php echo $category['name']; ?> Room</span>
                                                    <br>
                                                    <span style="font-size: 14px;color:grey;">
                                                        <?php
                                        $category1=explode(',',$category['amenities']);
                                   ...
                                   ?>
                                    ...
                                    <span style="font-size: 18px !important;"> From &#8377;<?php echo number_format($category['price'],2); ?></span> &nbsp;&nbsp;&nbsp;
                                </div> -->
                                            </div>
                                            <?php
                                $this->load->model('Hotel_model');
                                $result=$this->Hotel_model->getSubcate($category['category_id'],$hotels['id']);
                               ...
                               if(!empty($result))
                               {
                                ...
                                {
                                ?>
                                                <form action="<?php echo base_url(); ?>index.php/reservation/add/<?php echo $hotels['id']; ?>/<?php echo $category['category_id']; ?>/<?php echo $daterange; ?>/<?php echo $rooms; ?>"
                                                    method="GET">
                                                    <div class="row" style="border-bottom:1px solid lightgray;padding: 20px 0px;">
                                                        <div class="col-md-9">
                                                            <input type="radio" name="optradio" value="<?php echo $result['sub_category_id']; ?>">
                                                            <span style="padding-left:15px;font-size: 14px !important;padding-top: 4%;">
                                                                <?php echo $result['name']; ?> </span>
                                                            <span style="color: #29b387;font-size: 13px !important;">
                                                                <b>
                                                                    <?php echo (100-(($result['price']/$result['base_price'])*100));?> %off</b>
                                                            </span>
                                                        </div>
                                                        <div class="col-md-3 ">
                                                            <strike>
                                                                <span style="font-size: 16px;color: grey;">₹
                                                                    <?php echo $result['base_price']; ?> </span>
                                                            </strike> &nbsp;
                                                            <span>₹
                                                        ...
                                                        <form action="<?php echo base_url(); ?>index.php/reservation/add/<?php echo $hotels['id']; ?>/<?php echo $category['category_id']; ?>/<?php echo $daterange; ?>/<?php echo $rooms; ?>"
                                                            ...
                                                            <div class="row" style="padding: 20px 0px;">
                                                                ...
                                                                <div class="col-md-3 ">
                                                                    <strike>
                                                                        <span style="font-size: 16px;color: grey;">₹
                                                                            <?php echo number_format($category['base_price'],2); ?> </span>
                                                                    </strike>
                                                                    <br>
                                                                    <span style="font-size: 12px;">₹
                                                                        <?php echo number_format($category['price'],2); ?> Per Room/Night</span>
                                                                </div>
                                                                <div class="col-md-6">
                              ...
                              ?>
                                                                    <div class="col-md-3 col-md-offset-9 text-center" style="margin-top:20px;">

                                                                        <!--  <a style="padding: 10px 20px;background-color:#8dc53f;color: white;border: 1px solid #8dc53f;border-radius: 5px;"  href="<?php echo base_url(); ?>index.php/reservation/add/<?php echo $hotels['id']; ?>/<?php echo $category['category_id']; ?>/<?php echo $daterange; ?>/<?php echo $rooms; ?>" >Continue</a> -->
                                                                        <input type="submit" value="Continue" class="btn btn-success" style="padding: 10px 20px;background-color:#8dc53f;color: white;border: 1px solid #8dc53f;border-radius: 5px;">
                                                                    </div>
...
?>
                        ...
                        <?php
                            ...
                            <iframe src="http://maps.google.com/?q=<?php echo $cord['latitude']; ?>,<?php echo $cord['longitude']; ?>&output=embed" id="someFrame"
                                scrolling="yes" frameborder="0" width="100%" height="150"></iframe>
                            <?php
                            }
                            ?>
                                <?php
...
<script>
    var myLatlng = new google.maps.LatLng(<?php echo $cord['latitude']; ?>, <?php echo $cord['longitude']; ?>);
