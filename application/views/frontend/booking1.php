...
data-target="#myModal" id="cngeRmsAnc" >Edit Rooms</a>
</span>
        ...
        <div class="col-md-12">
          <div>
            ...
            -->    
              ...
              <div class="row">
					<div class="col-md-6">
						<button  class="continue" style="<?php if($count==0){?><?php echo'display: none;';}?>padding: 10px 20px;background-color:#f79517;color: white;border: 1px solid #f79517;border-radius: 5px;" >Continue Booking </button>
					</div>
              </div>
            </div>
          </div>
...
<div class='container'>
  <div class="row" style='margin-bottom:5px'>
    <div class="col-md-6" style="border-right: 1px solid lightgray;">
      ...
      <!--<br>-->
      <p><?php  echo $hotels['hotel_about']; ?></p>
      <br>
...
?>
      ...
      <div class='col-md-8 col-md-offset-1' align='center'>
        <button style="background-color:#f79517" type='submit' class='btn btn-success' style='border-radius:10px;margin:10px;'>
          <a itemProp='URL' class='direction-link' target='_blank' href='http://maps.google.com/maps?saddr=My+Location&daddr=<?php echo $address; ?>'
             style='text-decoration:none;color:white;margin-top:5px'>Directions
          </a>
        </button>
      </div>
    </div>
      ...
      <div class="col-md-12">
		...
		?>
			<div class="col-md-4" style="margin:1% 0px;">
			  ...
			  <img src="<?php echo $amenity['icon']; ?>" width="14px" onerror="this.src='https://res.cloudinary.com/mallinamala/image/upload/v1620106252/olakite_amenities/tick_mfdhy9.svg';">
