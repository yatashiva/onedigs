...
h5 {
    ...
    <body  style=" color: #404040; -webkit-font-smoothing: auto;">
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <!--        <img src="https://res.cloudinary.com/mallinamala/image/upload/v1618988464/success_h4ekuw.svg" width="580" border="0"  class="img-max" style="display: block; padding: 0; font-family: Helvetica, Arial, sans-serif; color: #666666; width: 580px; height: 6px;">-->
                                    <!--    </td>-->
                                    <!--</tr>-->
                                    <!-- CONFIRMATION COPY -->
                                    <tr>
                                        <td bgcolor="#005b80" style="padding: 50px 0 50px 0;" class="pad-header">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td align="center" style="font-size: 20px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #EBEBEB; font-weight: 300;" class="pad-header-copy">
                                                        <img src="https://res.cloudinary.com/mallinamala/image/upload/v1618988464/success_h4ekuw.svg" width="100px"><br>
                                                ...
                                                <tr>
                                                    <td align="center" style="font-size: 42px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #EBEBEB; font-weight: 300;" class="pad-header-copy">
                                                        ...
                                                        <!--<br><br>-->
                                                        <!--<h6 style="font-size:22px;color:#fff">BOOKING ID - #1234</h6>-->
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="padding: 0 0 5px 0;">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="26%" align="left" class="responsive-table">
                                                                    <tr>
                                                                        <td align="center" style="padding: 0 0 0 0; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #999999; font-weight: 600; font-size: 16px; line-height: 22px; text-align: left;" bgcolor="#ffffff" class="flex-p-bold">
                                                                            Check-in:
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="70%" align="right" class="responsive-table">
                                                                    <tr>
                                                                        <td align="center" style="padding: 0 0 0 0; font-family: Arial, sans-serif; color: #333333; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #00b1b1; font-weight: 400; font-size: 16px; line-height: 22px; text-align: left;" bgcolor="#ffffff" class="flex-p">
