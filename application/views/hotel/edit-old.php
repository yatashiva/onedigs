          ...
          <div class="tab-content">
            <div class="tab-pane fade in active show" id="tab1default">
              ...
              <div>
                <div class="col-md-6 col-sm-12">
				 <div class = "form-group">
                  ...
                  <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $hotel['hotel_name']; ?>" name="hotel_name" required >
                </div>
                </div>
                <div class="col-md-6 col-sm-12 ">
				<div class = "form-group">
                  <label class = "mdl-textfield__label" for="exampleInputEmail1">Hotel Image</label>
                  <input type="file" class = "form-control" id="exampleInputEmail1" name="hotel_pic" >
              ...
              <div>
                <div class="col-md-6 col-sm-12 col-xs-12">
				 <div class = "form-group">
                  ...
                  <select class = "form-control" name="hotel_grade" style='height:35px' required>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
				 <div class = "form-group">
                  ...
                  <input type="text" class = "form-control" id="exampleInputEmail1"  value="<?php echo $hotel['total_rooms']; ?>" name="total_rooms" required>
                </div>
                </div>
              </div>
              ...
              <div class='col-md-12 col-xs-12 col-sm-12'>
                ...
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $hotel['location']; ?>" name="location"  required>
                </div>
              </div>
               <div class='col-md-12 col-xs-12 col-sm-12'>
                ...
                <div class="form-group" style='padding-right:0px;padding-left:0px;'>
                  ...
                  <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $hotel['area']; ?>" name="area" required>
                </div>
              </div>
              <div class="form-group">
               ...
               <div class="col-md-12" style='padding-right:0px;padding-left:0px;'> 
                  ...
                  <!--    <form>  -->
                     <div class="form-group input-group"> 
                         <input type="text" id="search_location" class = "form-control" placeholder="Search location"  value="<?php echo $hotel['hotel_address']; ?>" > 
  ...
  <script>
			...
			<!-- </div> -->
              ...
              <div>
				...
				<div class="form-group">
                  ...
                  <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $hotel['hotel_phone_no']; ?>" name="hotel_phone_no" required>
                </div>
                </div>
                <div class="col-md-6 col-sm-12 ">
				<div class="form-group">
                  <label class = "mdl-textfield__label" for="exampleInputEmail1"> Email</label>
                  <input type="email" class = "form-control" id="exampleInputEmail1" value="<?php echo $hotel['email']; ?>" name="hotel_email" required>
                </div>
                </div>
              </div>
              ...
              <div>
				...
				<div class="form-group">
                  ...
                  <select class = "form-control" name="vendor_name" style='height:40px' required>
                    <?php
			...
			<div>	
              ...
              <div class="form-group">
                ...
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['account_number']; ?>" name="hotel_acc_no" required>
              </div>
              </div>
			  <div class='col-md-6'>
              <div class="form-group">
                <label class = "mdl-textfield__label" for="exampleInputEmail1">IFSC code</label>
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['ifsc']; ?>" name="hotel_ifsc_code"  required>
              </div>
              </div>
			</div> 
			<div>
              ...
              <div class="form-group">
                ...
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['name']; ?>" name="fullname" required>
              </div>
              </div>
			  <div class='col-md-6'>
              <div class="form-group">
                <label class = "mdl-textfield__label" for="exampleInputEmail1">Branch</label>
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['branch']; ?>" name="acc_branch"  required>
              </div>
              </div>
        ...
        <div class='col-md-6'>
              <div class="form-group">
                ...
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['GST_no']; ?>" name="gst_no"  required>
              </div>
              </div>
        ...
        <div class='col-md-6'>
              <div class="form-group">
                ...
                <input type="text" class = "form-control" id="exampleInputEmail1" value="<?php echo $bankdetails['PAN_no']; ?>" name="pan_no"  required>
              </div>
              </div>
            ...
            <div class="tab-pane fade" id="tab6default">
              <div class="form-group">
                ...
                <textarea type="text" class = "form-control" id="exampleInputEmail1" name="hotel_policy"  required><?php echo $policies['policy']; ?></textarea>
              </div>
           
            
              <div class="form-group">
                <label class = "mdl-textfield__label" for="exampleInputEmail1">Cancellation Policy</label>
                <textarea type="text" class = "form-control" id="exampleInputEmail1" name="hotel_cancel_policy"  ><?php echo $cancellation['cancellation_policy']; ?></textarea>
              </div>
             </div>
...
<div class="img-wrap">
    ...
    $i=0;
          ...
          <td data-name="min">
                <input type="text" name="min<?php echo $i; ?>" class = "form-control" value="<?php echo $row['min']; ?>" style="width:200px;border-radius:5px;margin:5px;" >
                      
            </td>
            
            <td data-name="max">
                <input type="text" name='max<?php echo $i; ?>' value="<?php echo $row['max']; ?>" class = "form-control"  style="width:200px;border-radius:5px;margin:5px;"  />
            </td>
      
             <td data-name="tax">
                <input type="text" name='tax<?php echo $i; ?>' value="<?php echo $row['tax']; ?>" class = "form-control"  style="width:200px;border-radius:5px;margin:5px;"  />
            </td>
             <td data-name="del">
              <button type="button" name="del<?php echo $i; ?>" class='btn btn-danger glyphicon glyphicon-remove row-remove'></button>
             </td>
       <td data-name="id">
                <input type="hidden" name='id<?php echo $i; ?>' value="<?php echo $row['id']; ?>" class = "form-control"  style="width:200px;border-radius:5px;margin:5px;"  />
            </td>
          </tr>
      <?php
      $i++;
