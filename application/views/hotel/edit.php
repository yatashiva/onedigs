...
<style type="text/css">
  ...
  ul#geoData span {
											...
											<div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
												<div class="col-xl-12 col-xxl-7">
													...
													<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
														...
														<form class="form" id="kt_projects_add_form"  action="<?php echo base_url();?>index.php/hotel/edit/<?php echo $hotel['id']; ?>" method="POST" enctype="multipart/form-data" name="myform">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                       <div class="form-group">
   <label>Hotel Name</label>
   <input type="text" value="<?php echo $hotel['hotel_name']; ?>" name="hotel_name" required  class="form-control" placeholder="Enter Hotel Name"/>
   ...
   <input type="file" class="form-control" name="hotel_pic"/>
  ...
  <div class="row">
   ...
   <label>Hotel Grade</label>
    <select class ="form-control" id="grade" name="hotel_grade" required>
   ...
   <input type="text" class="form-control" placeholder="Enter Total rooms" name="total_rooms" value="<?php echo $hotel['total_rooms']; ?>" required/>
   ...
   <label>Top Hotel</label><br>
    Yes  <input type="radio" name="top_hotel" value = "yes" style="margin-right:20px;" <?php echo ($hotel['top_hotel']=='yes')?'checked':'' ?>/>  
                  No   <input type="radio" name="top_hotel" <?php echo ($hotel['top_hotel']=='no')?'checked':'' ?> value="no" style="margin-right:20px;"  />
  </div> 
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-6">
                       <div class="form-group">
   <label>City</label>
   <input type="text" name="location" required class="form-control" value="<?php echo $hotel['location']; ?>" placeholder="Enter City"/>
   ...
   <input type="text" class="form-control" value="<?php echo $hotel['area']; ?>" placeholder="Enter Area" name="area" required/>
...
<div class="row">
   ...
   <input type="text" class="form-control" value="<?php echo $hotel['hotel_address']; ?>"  id="search_location" placeholder="Search location" name="searchlocation" required/>
 ...
 <div class="row">
   ...
   <input type="text" class="form-control" value="<?php echo $hotel['hotel_phone_no']; ?>" placeholder="Enter Phone Number" name="hotel_phone_no" required/>
  </div> 
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
   <label>Email</label>
   <input value="<?php echo $hotel['email']; ?>" type="text" class="form-control" placeholder="Enter EmailId" name="hotel_email" required/>
...
<?php
   ...
   <input type="text" value="<?php echo $bankdetails['account_number']; ?>" name="hotel_acc_no" required class="form-control" placeholder="Enter Account No"/>
                    ...
                    <div class="col-md-3">
                       <div class="form-group">
   <label>IFSC</label>
   <input type="text" value="<?php echo $bankdetails['ifsc']; ?>" class="form-control" placeholder="Enter IFSC" name="hotel_ifsc_code" required/>
   ...
   <input type="text" class="form-control" value="<?php echo $bankdetails['name']; ?>" placeholder="Enter Full Name" name="fullname" required/>
                    ...
                    <div class="col-md-3">
                       <div class="form-group">
   <label>Branch</label>
   <input value="<?php echo $bankdetails['branch']; ?>" type="text" class="form-control" placeholder="Enter Bank Branch" name="acc_branch" required/>
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
   <label>GSTIN</label>
   <input value="<?php echo $bankdetails['GST_no']; ?>" type="text" class="form-control" placeholder="Enter GSTIN" name="gst_no" required/>
                    ...
                    <div class="col-md-6">
                       <div class="form-group">
   <label>PAN</label>
   <input value="<?php echo $bankdetails['PAN_no']; ?>" type="text" class="form-control" placeholder="Enter PAN No" name="pan_no" required/>
   ...
   <input type="text" class = "form-control" id="latitude" value="<?php echo $latlong['latitude']; ?>" name="hotel_latitude" required>
   ...
   <input type="text" class = "form-control" id="longitude" value="<?php echo $latlong['longitude']; ?>" name="hotel_longitude" required>
    ...
    <div class="col-md-12">
     <textarea name="hotel_policy" class="form-control" data-provide="markdown" required rows="10"><?php echo $policies['policy']; ?></textarea>
    </div>
   </div>
   ...
   <div class="form-group">
    ...
    <div class="col-md-12">
     <textarea name="hotel_cancel_policy" class="form-control" data-provide="markdown" required rows="10"><?php echo $cancellation['cancellation_policy']; ?></textarea>
    </div>
   </div>
   <div class="form-group">
    <label>About Hotel</label>
    <div class="col-md-12">
     <textarea name="" class="form-control" data-provide="markdown" required rows="10"><?php echo $hotel['hotel_about']; ?></textarea>
    </div>
   </div>
													...
													<div class="form-group row align-items-center">
																		...
																		<div class="col-lg-9 col-xl-6">
																			<div class="checkbox-inline">
																				...
																				<input name="pay_at_hotel" <?php echo ($payathotel['pay_at_hotel']=='on')?'checked':'' ?>  value="on" type="radio" />
																				<span></span>On</label>
																				<label class="checkbox">
																				<input <?php echo ($payathotel['pay_at_hotel']=='off')?'checked':'' ?> name="pay_at_hotel" value="off" type="radio" />
																				<span></span>Off</label>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAScIOzzgjWSSmaFPm0iCk7PtHgeBHRBFc"></script>
