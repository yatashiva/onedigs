										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0 py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Taxes</span>
                                        ...
                                        ?>
                                          ...
                                          <td><?php echo $row['tax']; ?></td>
																<td class="pr-0 text-right">
																	...
																	<a href="<?php echo base_url(); ?>index.php/taxes/edit/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																	...
																	<a href="<?php echo base_url(); ?>index.php/taxes/remove/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
