							    ...
							    <div class="row">
							        ...
							        <div class="col-xl-12">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header py-5">
												<h3 class="card-title align-items-start flex-column">
													<span class="card-label font-weight-bolder text-dark">Amenity Management</span>
                                        ...
                                        ?>
                                          ...
                                          <td><img src="<?php echo $row['icon']; ?>" width="20px"></td>
                                          <td><?php echo $row['created_at']; ?></td>
                                       
															
																<td>
																
																	<a href="<?php echo base_url(); ?>index.php/amenity/edit/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																	...
																	<a href="<?php echo base_url(); ?>index.php/amenity/remove/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
