...
<div class="page-bar">
  ...
  <div class="card-box col-md-12  modal-body">
    <div class='card-head'>
	 ...
	 <div class='card-body'>
        <form action="<?php echo base_url(); ?>index.php/room_category/edit/<?php echo $room_category['id']; ?>" method="POST" enctype="multipart/form-data" style='width:100%'>
	   ...
	   <div>
			...
			<div class='col-md-6'>	
                ...
                <input type="text" class = "mdl-textfield__input" id="exampleInputEmail1"  name="category_name" placeholder="Enter Room Category" value="<?php echo $room_category['category_name']; ?>" >
				</div>
			</div>	
		</div>	
		<div>
			 <div class='col-md-6'>		
                ...
                <input type="number" class = "mdl-textfield__input" id="exampleInputEmail1"  name="no_of_rooms" placeholder="Enter No Of Rooms " value="<?php echo $room_category['no_of_rooms']; ?>">
			 ...
			 <div class='col-md-6'>	
			  <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                ...
                <input type="file" class = "mdl-textfield__input" id="r"  name="hotel_gallery[]"  multiple >
		...
		<div>
			<div class='col-md-6'>
              <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                ...
                <input type="number" class = "mdl-textfield__input" id="exampleInputEmail1"  name="capacity" placeholder="Enter Capacity " value="<?php echo $room_category['capacity']; ?>">
			...
			<div class='col-md-6'>	
                ...
                <input type="text" class = "mdl-textfield__input" id="exampleInputEmail1" placeholder="Enter actual Price" name="price" value="<?php echo $room_category['baseprice']; ?>" pattern = "-?[0-9]*(\.[0-9]+)?">
		...
		<div>	
			<div class='col-md-6'>
              <div class="mdl-textfield mdl-js-textfield" style='z-index:99999'>
                ...
                <input type="text" class = "mdl-textfield__input" id="exampleInputEmail1" placeholder="Enter Final  Price" name="price" value="<?php echo $room_category['price']; ?>" pattern = "-?[0-9]*(\.[0-9]+)?">
				   <span class = "mdl-textfield__error">Number required!</span>
              </div>
            </div> 
               <div class="col-md-6 col-sm-12 ">
				...
				<select class="mdl-textfield__input" name="amenities[]" id="amenity" multiple>
                <?php
			...
			<div class='col-md-12'> 
                ...
                <textarea class = "mdl-textfield__input" id="exampleInputEmail1"  name="description" >"<?php echo $room_category['description']; ?>"</textarea>
              </div>
            </div> 
