                                               ...
                                               ?>
                                                ...
                                                ?>
																...
																<td class="pr-0 text-right">
																	...
																	<a href="<?php echo base_url(); ?>index.php/room_category/edit/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																	...
																	<a href="<?php echo base_url(); ?>index.php/room_category/remove/<?php echo $row['id']; ?>" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
